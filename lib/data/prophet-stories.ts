...
//
// ИСТОЧНИКИ (строго):
//   1. Коран — текст Откровения, цитаты по переводу Э. Кулиева.
...
//   • Стиль: спокойный рассказчик для ребёнка 4-10 лет. Простой образный
//     русский язык. Без академизма, без сюсюканья.
...
//
// TODO (переводы):
//   На первой итерации содержание только на русском. Для tg/uz/kk/ky
//   тексты должны быть переведены и проверены муфассирами (Шейх Мухаммад
//   Содык Юсуф для uz, Халифа Алтай для kk, и т.д.). До этого фронтенд
//   показывает русский текст во всех локалях.
//
// TODO (аудио):
